...
def BMI():
    ...
    #value can be changed bcoz every country has different bmi index
    if bmi<=18.5:
...
Height=StringVar()
Weight=StringVar()
height=Entry(root,textvariable=Height,width=5,font='arial 50',bg="#fff",fg="#000",bd=0,justify=CENTER) #TO NALIGN TEXT IN CENTER
height.place(x=35,y=160)
Height.set(get_current_value())



weight=Entry(root,textvariable=Weight,width=5,font='arial 50',bg="#fff",fg="#000",bd=0,justify=CENTER) #TO NALIGN TEXT IN CENTER
